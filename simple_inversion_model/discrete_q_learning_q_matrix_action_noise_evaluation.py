...
# evaluation metrics for the discrete_q_learning_q_matrix_action_noise case, as specified in the 'Evaluating RL algorithms' document.
...
from discrete_q_learning_q_matrix_action_noise import DiscreteQLearningActionNoiseQMatrix  # import RL agent class
...
def main_quantitative():
    ...
    agent = DiscreteQLearningActionNoiseQMatrix()  # create agent
