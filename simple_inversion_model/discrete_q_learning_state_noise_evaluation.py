...
# evaluation metrics for the discrete_q_learning_state_noise case, as specified in the 'Evaluating RL algorithms' document.
...
from discrete_q_learning_state_noise import DiscreteQLearningStateNoise  # import RL agent class
...
def main_quantitative():
    ...
    # (1) 15,000 = number of batches until convergence

    agent = DiscreteQLearningStateNoise()  # create agent
