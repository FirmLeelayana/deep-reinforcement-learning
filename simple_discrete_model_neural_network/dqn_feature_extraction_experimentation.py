...
# NOTE 2: This file is an experimentation file; we will change variables until we find something that works.
...
class DQN_varying_time_steps:
    ...
    def _build_model(self):
        ...
        model.add(keras.layers.Dense(12, input_shape=(self.state_size,), activation='relu', kernel_initializer=init))
...
if __name__ == "__main__":
    ...
    agent = DQN_varying_time_steps(given_time_steps=3, number_of_episodes_per_batch=10, number_of_batches=100000)  # (1) X = number of batches until convergence
