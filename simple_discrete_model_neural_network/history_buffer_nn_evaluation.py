...
# evaluation metrics for the history_buffer_nn case, as specified in the 'Evaluating RL algorithms' document.
...
from history_buffer_nn import DQN_history_buffer  # import RL agent class
