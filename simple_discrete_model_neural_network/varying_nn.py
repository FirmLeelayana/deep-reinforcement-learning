...
# In this implementation, we will be using various neural network implementations in order to investigate the tradeoff properties.
...
class DQN:
    ...
    def _build_model(self):
        ...
        model.add(keras.layers.Dense(100, input_shape=(self.state_size,), activation='relu', kernel_initializer=init))    # Hidden Layer 1 = 24 nodes, ReLU activation function, He init.
        model.add(keras.layers.Dense(80, input_shape=(self.state_size,), activation='relu', kernel_initializer=init))    # Hidden Layer 1 = 24 nodes, ReLU activation function, He init.
        model.add(keras.layers.Dense(80, input_shape=(self.state_size,), activation='relu', kernel_initializer=init))    # Hidden Layer 1 = 24 nodes, ReLU activation function, He init.
        model.add(keras.layers.Dense(80, input_shape=(self.state_size,), activation='relu', kernel_initializer=init))    # Hidden Layer 1 = 24 nodes, ReLU activation function, He init.
        model.add(keras.layers.Dense(80, input_shape=(self.state_size,), activation='relu', kernel_initializer=init))    # Hidden Layer 1 = 24 nodes, ReLU activation function, He init.
        model.add(keras.layers.Dense(60, input_shape=(self.state_size,), activation='relu', kernel_initializer=init))    # Hidden Layer 1 = 24 nodes, ReLU activation function, He init.
        model.add(keras.layers.Dense(40, input_shape=(self.state_size,), activation='relu', kernel_initializer=init))    # Hidden Layer 1 = 24 nodes, ReLU activation function, He init.
        model.add(keras.layers.Dense(20, input_shape=(self.state_size,), activation='relu', kernel_initializer=init))    # Hidden Layer 1 = 24 nodes, ReLU activation function, He init.
